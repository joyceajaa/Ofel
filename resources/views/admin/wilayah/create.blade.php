...
<head>
    ...
    <title>Tambah Wilayah Baru - {{ config('app.name', 'Laravel') }}</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Tambah Wilayah Baru</h1>

                    <!-- Form untuk Menambah Wilayah -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Tambah Wilayah</h6>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.wilayahs.store') }}" method="POST">
                                @csrf
